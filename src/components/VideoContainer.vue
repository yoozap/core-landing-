<template>
  ...
  >
    <div class="video-container__close" @click="closeVideo">
      ...
      >
        <path
          d="M38.75 1.25L1.25 38.75"
          stroke="rgba(73,223,143,1)"
          stroke-width="4"
        />
        <path
          d="M1.25 1.25L38.75 38.75"
          stroke="rgba(73,223,143,1)"
          stroke-width="4"
        />
      </svg>
    ...
    <VideoStream
      ...
      controls
      autoplay
      src="a6556f211b0e2f7905c243b0f58e5eec"
    />
